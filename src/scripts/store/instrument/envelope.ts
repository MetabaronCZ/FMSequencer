...
const setInstrumentOperatorEnvelopeAction: ProjectReducer<SetInstrumentEnvelopeActionAction> = (state, action) => {
...
const setInstrumentOperatorEnvelopeDecay: ProjectReducer<SetInstrumentEnvelopeDecayAction> = (state, action) => {
    const { track, operator, data } = action.payload;
...
const setInstrumentOperatorEnvelopeSustain: ProjectReducer<SetInstrumentEnvelopeSustainAction> = (state, action) => {
    const { track, operator, data } = action.payload;
...
const setInstrumentOperatorEnvelopeRelease: ProjectReducer<SetInstrumentEnvelopeReleaseAction> = (state, action) => {
    const { track, operator, data } = action.payload;
