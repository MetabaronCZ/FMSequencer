...
type SetInstrumentFilterTypeAction = PayloadAction<
  TrackActionPayload<FilterTypeID>
>;
type SetInstrumentFilterCutoffAction = PayloadAction<
  TrackActionPayload<number>
>;
type SetInstrumentFilterResonanceAction = PayloadAction<
  TrackActionPayload<number>
>;
...
const setInstrumentFilterType: ProjectReducer<SetInstrumentFilterTypeAction> = (
  state,
  action
) => {
...
const setInstrumentFilterCutoff: ProjectReducer<
  SetInstrumentFilterCutoffAction
> = (state, action) => {
  const { track, data } = action.payload;
...
const setInstrumentFilterResonance: ProjectReducer<
  SetInstrumentFilterResonanceAction
> = (state, action) => {
  const { track, data } = action.payload;
