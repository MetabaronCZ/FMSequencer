...
type SetSequenceTrackPatternAction =
  PayloadAction<SetTrackPatternActionPayload>;
...
const setSequenceLength: ProjectReducer<SetSequenceLengthAction> = (
  state,
  action
) => {
...
const setSequenceTrackPattern: ProjectReducer<SetSequenceTrackPatternAction> = (
  state,
  action
) => {
